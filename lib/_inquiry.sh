...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao ZapFlow 4.5, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [1] Instalar ZapFlow 4.5 \n"
  # printf "   [1] Atualizar ZapFlow SaaS \n"
  printf "   [2] Deletar ZapFlow 4.5 \n"
  printf "   [3] Bloquear ZapFlow 4.5 \n"
  printf "   [4] Desbloquear ZapFlow 4.5 \n"
  printf "   [5] Alter. dominio ZapFlow 4.5 \n"
  printf "\n"
  read -p "> " option
